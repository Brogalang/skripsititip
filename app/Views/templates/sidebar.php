<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('/pages/data_sales'); ?>">
            ...
            <span class="text-gray-900">Data Sales</span></a>
    </li>

    <!-- Nav Item - Rating Result -->
    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('/pages/rating'); ?>">
            <i class="text-gray-900 fas fa-fw fa-chart-area"></i>
            <span class="text-gray-900">Rating Result</span></a>
    </li>
